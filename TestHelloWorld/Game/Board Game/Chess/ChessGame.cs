		...
		namespace BoardGames {
			namespace Chess {
				...
				public partial class ChessGame : BoardGame {
					...
					public IReadOnlyList<ChessPiece> chessPieces {
						get {
					...
					public void CheckRulesBeforeMove(ChessPlayer player, ChessMove move, ChessPiece piece,
						...
						CheckRulesBeforeMove(player, move, piece, new List<ChessRule>(),
					...
					private void CheckRulesBeforeMove(ChessPlayer player, ChessMove move, ChessPiece piece,
													 IList<ChessRule> rulesThatApply,
													 bool checkIfOwnKingIsInCheck) {
					...
					private void ExecuteRulesAfterMove(IList<ChessRule> rulesThatApply,
					...
					public IReadOnlyList<string> moveList {
						get {
							return _moveList;
						}
					}
