		...
		namespace Chess {
			public partial class ChessGame {
				...
				public void GetPiecesFromListThatCanBlockAPiecesMove(ChessPlayer player,
																	...
																	List<ChessPiece> opposingPieces,
				...
				public void GetPiecesFromListThatAreIntheWayOfAMove(ChessMove move, ChessPiece piece, List<ChessPiece> pieces,
																	ref List<ChessPiece> piecesInTheWay) {
					...
					while (true == move.TakeStep(stepCount, ref tempCoordinates) &&
						...
						if (null != occupyingPiece &&
						    null != pieces.Find(p => p == occupyingPiece)) {
				...
				private void GetPiecesFromListThatCanMoveToCoordinate(ChessCoordinate c, List<ChessPiece> pieces,
				...
				public void GetPiecesFromListThatCanLegallyMoveToCoordinate(ChessCoordinate c, List<ChessPiece> pieces,
				                                             ref ChessPieceToChessMoveDictionary validPiecesAndMoves) {
